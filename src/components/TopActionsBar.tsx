...
export const TopActionsBar: React.FC<TopActionsBarProps> = ({
  ...
  return (
    <div className="mb-6 rounded-2xl bg-[#0c1220]/80 backdrop-blur-xl border border-white/[0.08] p-3 sm:p-4 shadow-[0_8px_30px_rgba(0,0,0,0.4)]">
      <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3">
        ...
        <div className="flex items-center justify-between sm:justify-end gap-2.5 pt-2 md:pt-0 border-t md:border-t-0 border-white/[0.08] flex-wrap">
          ...
          <div className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-[#090e1a]/90 border border-white/[0.08] text-xs shadow-inner">
          ...
          <button
            ...
            disabled={isSyncing}
            className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-[#141d30] hover:bg-[#1a2640] active:scale-95 border border-white/[0.08] text-xs font-bold text-slate-200 transition-all disabled:opacity-50 cursor-pointer shadow-sm"
