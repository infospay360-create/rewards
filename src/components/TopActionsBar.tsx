        ...
        <div className="flex items-center justify-between sm:justify-end gap-3 pt-2 md:pt-0 border-t md:border-t-0 border-slate-800/80">
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-slate-950/80 border border-slate-800 text-xs">
            ...
            <span className="text-slate-300 font-medium text-[11px]">
              Live Synced <span className="hidden sm:inline text-slate-500">• All Devices</span>
            </span>
          </div>
          ...
          <button
            ...
            disabled={isSyncing}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-800 hover:bg-slate-700 active:scale-95 border border-slate-700 text-xs font-bold text-slate-200 transition-all disabled:opacity-50"
